...
export const  message = {
    ...
    account_mine:"我",
    account_tooltip_withDraw:"提现到阿希主链",
    account_tooltip_trans:"DDC侧链内部转账",
    account_tooltip_Recharge:"充值到DDC侧链",
    account_height:"高度",
    account_height_time:"时间",
    account_card_asset:"DDC侧链资产",
    account_card_assetB:"阿希主链资产",
    
    acount_form_title:"提现",
    acount_form_title1:"金额（手续费为0.1XAS）",
    acount_form_title2:"币种",
    acount_form_title4:"金额（手续费为0.1XAS（主链））",
    ...
    trs_form_field_amount:"金额(手续费 0.1 dreamworld.DDC)",
    ...
    Kongtou_form_field_address:"DDC地址",
    Kongtou_form_input_placeholder:"请输入DDC地址",
    ...
    Kongtou_form_btn:"绑定",
    Kongtou_error_Address_NotNull:"DDC地址不能为空",
    Kongtou_error_Address_NotInteger:"DDC地址错误",
