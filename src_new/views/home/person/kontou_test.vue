<template>
	<el-row>
		<el-col :span="20" :offset="2">
				...
				<h2>阿希币用户兑换DDC：</h2>
                <p>兑换比例: 1XAS=10DDC(测试)</p>
				<p>阿希币合约地址：A8jCQAqALJonZXh12qdCHJaJf7W3GcXFAD</p>
				<p>阿希用户使用钱包向合约地址转账阿希币， 系统会自动兑换DDC到用户的DDC钱包中。</p>

				<h2>以太币用户兑换DDC:</h2>
                <p>兑换比例: 1ETH=100DDC(测试)</p>
                ...
                <h2>2）自动兑换DDC</h2>
                <p>以太币合约地址：0x6d124af0f7e464e14022840ee0aa0d3b7d5018b4</p>
                ...
                <p style="color:red">备注：签名与绑定只需要执行一次。</p>
